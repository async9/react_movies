...
const MovieDetails = () => {
  ...
  // api urls
  const apiMovieDetails = `https://api.themoviedb.org/3/movie/${itemId}?api_key=its-secret&language=en-US`;
  const apiMovieCredits = `https://api.themoviedb.org/3/movie/${itemId}/credits?api_key=its-secret&language=en-US`;
