...
import "../MovieTvDetails/MovieTvDetails.css";

const MovieDetails = () => {
  const { itemId } = useParams();

  // api urls
  const apiMovieDetails = `https://api.themoviedb.org/3/movie/${itemId}?api_key=9794e8bb02ba77223f102a1ab8f4e97d&language=en-US`;
  const apiMovieCredits = `https://api.themoviedb.org/3/movie/${itemId}/credits?api_key=9794e8bb02ba77223f102a1ab8f4e97d&language=en-US`;
  ...
  // api urls array
  const urls = [apiMovieDetails, apiMovieCredits];
    ...
    <>
      <div className="movie-tv-details__data-container">
        ...
        <section className="movie-tv-details__cast-card">
          ...
          {dataTwo && (
            <>
              <h2 className="movie-tv-details__cast-list">Movie cast</h2>
